...
const faq = [
  ...
  {
    q: "Можно ли менять дизайн Ready-сайта?",
    a: "Да. Мы адаптируем цветовую систему под бренд, меняем материалы и можем скорректировать композицию или отдельные блоки, если это не меняет общую концепцию. Существенная перестройка структуры, новый визуальный стиль, дополнительные страницы или новые функциональные модули рассчитываются отдельно.",
  },
  {
    q: "Входит ли SEO?",
        ...
        <section className="ready-paths section-shell">
          ...
          <div className="ready-paths-board">
            <article className="ready-path ready-path-featured">
              ...
              <div className="ready-path-prices">
                <div>
                  <span>Compact Site</span>
                  <strong>от 1 400 ₪</strong>
                </div>
                <div>
                  <span>Лендинг</span>
                  <strong>от 3 400 ₪</strong>
                </div>
                <div>
                  <span>Бизнес-сайт</span>
                  <strong>от 5 800 ₪</strong>
                </div>
              </div>
            ...
            <article className="ready-path ready-path-individual">
              ...
              <div className="ready-path-prices ready-path-prices-individual">
                ...
                <div>
                  <span>Лендинг</span>
                  <strong>от 5 500 ₪</strong>
                </div>
                <div>
                  <span>Бизнес-сайт</span>
                  <strong>от 9 900 ₪</strong>
                </div>
              </div>
          ...
          <div className="ready-paths-explainer">
            ...
            <p>
              ...
              с нуля рассчитывается от 11 900 ₪, а адаптация готовой
              MIDA-концепции — от 5 800 ₪.
            </p>
          </div>
        </section>
