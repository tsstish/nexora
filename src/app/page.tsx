...
function Approach(){return <section className="approach section-shell">
  ...
  <div className="approach-grid"><h2>Сначала смысл.<br/>Потом форма.</h2><p>Мы не собираем сайт из эффектов. Сначала понимаем задачу и цели бизнеса, затем превращаем это в сильный визуальный язык, понятную структуру и работающий интерфейс.</p><svg className="approach-arrow" viewBox="0 0 210 110" aria-hidden="true"><path d="M10 88C70 84 112 48 175 28"/><path d="M158 18L178 27L163 43"/></svg></div>
</section>}
